...
public class Robot extends IterativeRobot {
	...
	public void autonomousPeriodic() {
		autoTasks.startTask();
		SmartDashboard.putString("encoder frontLeft: ", ""+TPARobotDrive.frontLeftMotor.getPosition());
		SmartDashboard.putString("encoder backLeft: ", ""+TPARobotDrive.backLeftMotor.getPosition());
		SmartDashboard.putString("encoder frontRight: ", ""+TPARobotDrive.frontRightMotor.getPosition());
		SmartDashboard.putString("encoder backRight: ", ""+TPARobotDrive.backRightMotor.getPosition());
	}
